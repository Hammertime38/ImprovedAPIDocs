$(document).ready(function () {
    $("div[data-role='page']").live('pageinit', function () {
        ...
        if ($("#request-soap").length) {
            

            /* Request Pages */
            

            $("#request-nav a").click(function () {
                var href = $(this).attr("href");
                $("#request div").hide();
                $(href).show();
            });
            
            $("#response-nav a").click(function () {
                var href = $(this).attr("href");
                $("#response div").hide();
                $(href).show();
            });
        ...
        else if ($("#wrap_appointments").length) {
            ...
            $("#add_appointment").click(function () {
                ...
                $("ul[data-role=collapsible]").find("a > span").find(".ui-btn-text").html("Appointment");
